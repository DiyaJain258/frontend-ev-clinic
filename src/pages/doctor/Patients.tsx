...
const DoctorPatients = () => {
    ...
    const getFollowup = (p: any) => {
        if (!p.medicalrecord || p.medicalrecord.length === 0) return null;
        try {
    ...
    const filteredPatients = patients.filter((p: any) => {
        ...
        if (activeTab === 'active') return !['Discharged', 'Inactive'].includes(p.status);
        if (activeTab === 'followup') return !!followup;
        if (activeTab === 'discharged') return p.status === 'Discharged';
                                ...
                                <div key={patient.id} className="patient-card-modern">
                                    ...
                                    <div className="patient-info-block">
                                        ...
                                        <div style={{ display: 'flex', gap: '8px', marginTop: '8px', flexWrap: 'wrap' }}>
                                            ...
                                            {followupDate && (
                                                <div className="last-visit-tag" style={{ background: '#FFF7ED', color: '#9A3412', border: '1px solid #FFEDD5' }}>
                                                    <FiActivity size={12} />
