                                    ...
                                    <div className="orders-container">
                                        {orders.map((order, index) => (
                                            <div key={index} className="order-row-single">
                                                    ...
                                                    {order.type === 'PHARMACY' ? (
                                                        ...
                                                        <div style={{ position: 'relative' }}>
                                                            ...
                                                            <datalist id={`services-list-${index}`}>
                                                                {clinicServices.filter(cs => cs.type === order.type && cs.isActive !== false).map(cs => (
                                                ...
                                                {order.type !== 'PHARMACY' && (
                                                    <div className="order-col-amount" style={{ flex: '0 0 15%', minWidth: '80px' }}>
                                                        <div style={{
                                                            padding: '8px 12px',
                                                            background: '#f8fafc',
                    ...
                    <div className="assessment-view-details">
                        ...
                        <div className="modal-actions-floating-bottom">
                            ...
                            <button
                                ...
                                style={{ background: 'linear-gradient(135deg, #2D3BAE 0%, #1E1B4B 100%)', color: 'white', border: 'none' }}
                                onClick={() => {
