                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
                    {selectedClinic?.logo && (
                        <div style={{ width: '60px', height: '60px', borderRadius: '12px', overflow: 'hidden', background: '#fff', border: '1px solid #E2E8F0', padding: '4px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                            <img
                                src={selectedClinic?.logo ? (selectedClinic.logo.startsWith('http') ? selectedClinic.logo : `${(import.meta.env.VITE_API_URL || '').replace(/\/api$/, '')}${selectedClinic.logo}`) : "/sidebar-logo.jpg"}
                                alt="Clinic Logo"
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="schedule-actions" style={{ marginLeft: 'auto', display: 'flex', gap: '8px' }}>
                                            ...
                                            {(booking.queueStatus === 'Pending' || booking.status === 'Confirmed' || booking.status === 'Approved' || (booking.status === 'Pending' && booking.source === 'Reception')) && (
                                                <button
