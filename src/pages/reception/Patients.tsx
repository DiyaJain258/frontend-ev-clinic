                ...
                <form className="modal-form" onSubmit={handleRegisterSubmit}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '130px 1fr', gap: '1rem', alignItems: 'start' }}>
                        <div className="form-group">
                            ...
                            <select
                                style={{ textAlign: 'center', padding: '0.6rem 0.5rem', width: '100%' }}
                                value={registrationForm.phone.split(' ')[0] || '+971'}
                                onChange={e => {
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                required
                                value={registrationForm.phone.includes(' ') ? registrationForm.phone.split(' ').slice(1).join(' ') : registrationForm.phone}
                                onChange={e => {
                    ...
                    <form className="modal-form" onSubmit={async (e: any) => {
                        ...
                        <div className="form-group">
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '130px 1fr', gap: '0.5rem' }}>
                                <select
                                    name="phoneCode"
                                    defaultValue={(selectedPatient.contact || selectedPatient.phone || '').split(' ')[0] || '+971'}
                                ...
                                <input
                                    name="phoneNumber"
                                    type="text"
                                    defaultValue={(selectedPatient.contact || selectedPatient.phone || '').includes(' ') ? (selectedPatient.contact || selectedPatient.phone || '').split(' ').slice(1).join(' ') : (selectedPatient.contact || selectedPatient.phone)}
                                    required
                                />
                            </div>
                        </div>
