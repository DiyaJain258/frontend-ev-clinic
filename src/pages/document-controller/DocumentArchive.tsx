...
const downloadRecord = async (r: any, clinic: any) => {
    try {
        const doc = new jsPDF();
        ...
        if (fileName) tableData.push(['File Name', fileName]);
                    ...
                    return (
                        <div style={{ lineHeight: 1.6 }}>
                            ...
                            <div style={{ marginTop: '1rem' }}>
                                <button
                                    onClick={() => { downloadRecord(viewRecord, selectedClinic); setViewRecord(null); }}
                                    style={{
                                        background: '#0f172a',
                                        color: 'white',
                                        border: 'none',
