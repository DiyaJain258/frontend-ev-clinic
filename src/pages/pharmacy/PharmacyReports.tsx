...
const PharmacyReports = () => {
    ...
    const downloadPDF = async () => {
        ...
        try {
            ...
            doc.text('Shift Breakdown', 15, (doc as any).lastAutoTable.finalY + 12);
            ...
            doc.text('Itemized Medicine Sales', 15, (doc as any).lastAutoTable.finalY + 12);

            const medicineBody = report.daily?.medicines?.length > 0
                ? report.daily.medicines.map((m: any) => [m.name, m.quantity])
                : [['No items sold', '-']];
            ...
            for (let i = 1; i <= pageCount; i++) {
                ...
                doc.text(
                    `Generated by System on ${new Date().toLocaleString()} | Page ${i} of ${pageCount}`,
