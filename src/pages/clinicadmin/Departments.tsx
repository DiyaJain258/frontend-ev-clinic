...
const Departments = () => {
    const { departments, addDepartment, deleteDepartment, staff } = useApp() as any;
            ...
            <div className="stats-grid">
                ...
                <div className="stat-card-dept">
                    ...
                    <div className="stat-info-dept">
                        ...
                        <h3 className="stat-value-dept">{departments.filter((d: any) => d.type === 'CLINICAL').length}</h3>
                    </div>
                </div>
                <div className="stat-card-dept">
                    ...
                    <div className="stat-info-dept">
                        ...
                        <h3 className="stat-value-dept">{departments.filter((d: any) => d.type === 'SERVICE').length}</h3>
                    </div>
                </div>
            </div>
                    ...
                    <table className="data-table">
                        ...
                        <tbody>
                            {filteredDepartments.map((dept: any) => {
                                const staffCount = staff?.filter((s: any) => s.department === dept.name).length || 0;
                                return (
                                    <tr key={dept.id}>
                                        <td>
