...
const PatientDashboard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setRecordsCount(
                    (recordsData.assessments?.length || 0) +
    ...
    return (
        <div className="p-6 fade-in" style={{ backgroundColor: '#f8fafc', minHeight: '100vh' }}>
                            ...
                            {activities.length > 0 ? (
                                <div className="timeline">
                                    {activities.map((act, idx) => (
                                        <div key={idx} className="timeline-item" style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem', position: 'relative' }}>
                                            ...
                                            <div className="timeline-content">
                                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                                                    ...
                                                    <small style={{ color: '#64748b' }}>{new Date(act.date).toLocaleDateString()}</small>
                                                </div>
                                ...
                                <div className="text-center p-lg text-muted">No recent activity found.</div>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="content-card">
                        ...
                        <div className="table-responsive" style={{ padding: '0.5rem 0' }}>
                            <table className="data-table">
                                ...
                                <tbody>
                                    {invoices.length > 0 ? invoices.slice(0, 3).map((inv: any) => (
                                        <tr key={inv.id}>
                    ...
                    <div className="content-card">
                        ...
                        <div className="upcoming-list">
                            {upcomingAppointments.length > 0 ? upcomingAppointments.map((app, idx) => (
                                ...
                                <div className="text-center p-md text-sm text-muted">No upcoming appointments.</div>
                            )}
