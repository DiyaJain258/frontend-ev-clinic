...
const AppointmentStatus = () => {
    ...
    const filteredBookings = bookings.filter(b => {
        const matchesSearch =
            (b.clinic?.name || '').toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    if (loading) {
        return (
            <div className="p-20 text-center flex flex-col items-center justify-center" style={{ minHeight: '60vh' }}>
        ...
        <div className="p-2 fade-in">
            ...
            <div className="appointment-controls no-print mb-lg">
                <div className="search-wrap">
                    ...
                    <input
                        type="text"
                        placeholder="Search clinic, doctor or service..."
                        value={searchTerm}
            ...
            {filteredBookings.length === 0 ? (
                ...
                <div className="appointments-grid-v2">
                    {filteredBookings.map((booking: any) => (
                        <div key={booking.id} className={`appointment-card-v2 ${getStatusClass(booking.status)}`}>
