...
const LabDashboard = () => {
    ...
    const fetchOrders = async () => {
        try {
            ...
            setStats({
                ...
                collected: data.filter((o: any) => (o.testStatus || o.status) === 'Sample Collected').length,
    ...
    const handlePrintReport = async (order: any) => {
        try {
            const doc = new jsPDF();
            let details: any = {};
            try { details = JSON.parse(order.result || '{}'); } catch (e) { details = { notes: order.result }; }
                    ...
                    <div className="table-container mt-md">
                        {loading ? (
                            ...
                            <table className="data-table">
                                ...
                                <tbody>
                                    {orders
                                        .filter((o: any) => ['Pending', 'Sample Collected'].includes(o.testStatus || o.status))
                                        .filter((o: any) =>
                                                        ...
                                                        <td>
                                                            {!isCollected ? (
                                                                <button
                                                                    ...
                                                                    style={{ padding: '0.4rem 0.75rem', fontSize: '0.75rem', background: isPaidStatus ? 'linear-gradient(135deg, #2D3BAE 0%, #1E1B4B 100%)' : '#CBD5E1', border: 'none', color: 'white' }}
                                                                >
                                                                ...
                                                                <button
                                                                    ...
                                                                    style={{ padding: '0.4rem 0.75rem', fontSize: '0.75rem', background: '#059669', border: 'none', color: 'white' }}
                                                                >
                ...
                <div className="content-card">
                    ...
                    <div className="table-container mt-md">
                        <table className="data-table">
                            ...
                            <tbody>
                                {orders
                                    .filter((o: any) => ['Published', 'Completed', 'Result Uploaded'].includes(o.testStatus || o.status))
                                    .filter((o: any) =>
                                        o.patient?.name?.toLowerCase().includes(searchTerm.toLowerCase()) ||
                                        o.testName?.toLowerCase().includes(searchTerm.toLowerCase())
                                    )
