    ...
    const fetchOrders = async () => {
        try {
            ...
            const parseRes = (response: any) => {
                ...
                if (response?.data !== undefined) return Array.isArray(response.data) ? response.data : [];
                return [];
            };
            ...
            <div className="content-section mt-xl">
                <div className="content-card">
                    <div className="card-header">
                        <h2><FiActivity /> Lab Technical Workflow</h2>
                    </div>
                            ...
                            <table className="data-table">
                                ...
                                <tbody>
                                    {orders.length > 0 ? orders.map((order: any) => {
                                            ...
                                            <tr key={order.id}>
                                                ...
                                                <td style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                                                    ...
                                                    <button
                                                        ...
                                                        title={!isCollected ? "Sample must be collected before uploading result" : ""}
                                                    >
                                        ...
                                        <tr><td colSpan={6} className="text-center p-lg text-muted">No pending lab requests.</td></tr>
                                    )}
                                </tbody>
                            </table>
                        )}
            ...
            <Modal isOpen={isUploadModalOpen} onClose={() => setIsUploadModalOpen(false)} title="Upload Lab Report">
                <form onSubmit={submitResult} className="modal-form">
                    ...
                    <div className="form-group">
                        ...
                        <textarea rows={4} className="form-control" placeholder="Enter findings or notes..." value={resultText} onChange={(e) => setResultText(e.target.value)} required={!selectedFile} />
                    </div>
