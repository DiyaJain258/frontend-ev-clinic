                            ...
                            <table className="data-table">
                                ...
                                <tbody>
                                    {orders.length > 0 ? orders.map((order: any) => {
                                            ...
                                            <tr key={order.id}>
                                                ...
                                                <td>
                                                    <button
                                                        ...
                                                        disabled={!isCollected && !isPaidStatus}
                                                        title={!isPaidStatus ? "Payment required" : ""}
                                                    >
                                        ...
                                        <tr><td colSpan={6} className="text-center p-lg text-muted">No radiology requests found.</td></tr>
                                    )}
                                </tbody>
                            </table>
                        )}
            ...
            <Modal isOpen={isUploadModalOpen} onClose={() => setIsUploadModalOpen(false)} title="Upload Radiology Report">
                <form onSubmit={submitResult} className="modal-form">
                    ...
                    <div className="form-group">
                        ...
                        <textarea rows={3} className="form-control" placeholder="Enter scan findings or notes..." value={resultText} onChange={(e) => setResultText(e.target.value)} required={!selectedFile} />
                    </div>
