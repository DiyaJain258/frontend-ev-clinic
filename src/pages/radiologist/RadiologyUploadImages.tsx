        ...
        <div className="dashboard-container fade-in">
                                            ...
                                            <tr key={order.id}>
                                                ...
                                                <td>
                                                    <button
                                                        ...
                                                        title={!isCollected ? "Sample must be marked as collected" : ""}
                                                    >
            ...
            <Modal isOpen={isUploadModalOpen} onClose={() => setIsUploadModalOpen(false)} title="Upload Images / Report">
                <form onSubmit={submitResult} className="modal-form">
                    ...
                    <div className="form-group">
                        <label>Attachment (Radiology Images / PDF Report)</label>
                        <div
                            style={{
                            ...
                            {!selectedFile ? (
                                <>
                                    ...
                                    <p style={{ fontSize: '0.875rem', color: '#64748B', margin: 0 }}>
                                        Click to browse or drag and drop PDF images/report
                                    </p>
                                    <input
                                        type="file"
                                        accept=".pdf"
