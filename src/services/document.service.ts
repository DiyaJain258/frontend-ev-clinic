...
export const documentService = {
    ...
    createRecord: async (data: { patientId: number; documentType: string; fileName?: string; notes?: string; fileData?: string }) => {
        return api.post('/document-controller/records', data);
    },

    createStaffRecord: async (data: { staffId: number; documentType: string; fileName?: string; notes?: string; fileData?: string }) => {
